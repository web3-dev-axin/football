...
const lines = [
  ...
  "- Product UX: `/schedule`, `SellPanel`, and odds deviation badge are covered by web render tests.",
  "- Data plane: `@worldcup/odds-ingestion`, odds schema, and import scripts produce report artifacts.",
